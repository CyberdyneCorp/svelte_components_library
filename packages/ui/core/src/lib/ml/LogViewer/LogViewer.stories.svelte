...
<Story name="Default" args={{ logs: defaultLogs }} />

<Story name="FilteredByError" args={{ filter: "error", logs: filteredLogs }} />

<Story name="WithSource" args={{ logs: sourceLogs }} />

<Story name="Cyberdyne System Logs" args={{ logs: systemLogs, maxHeight: "500px" }} />
